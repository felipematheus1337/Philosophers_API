...
export class default1671145908171 implements MigrationInterface {
    name = 'default1671145908171'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "philosophers" ("id" SERIAL NOT NULL, "name" text NOT NULL, "birthDate" text NOT NULL, "image" text, "country" text NOT NULL, "typePhilosophy" text NOT NULL, CONSTRAINT "PK_b787135daa78f000777be3f965a" PRIMARY KEY ("id"))`);
